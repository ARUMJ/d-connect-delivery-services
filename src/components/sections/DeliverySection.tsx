          ...
          <div className="relative grid grid-cols-1 gap-8 lg:grid-cols-12 lg:items-center">
            ...
            <div className="flex flex-col gap-3 lg:col-span-4 lg:items-end">
              <div className="flex w-full flex-col gap-3 sm:flex-row lg:w-auto">
                <Link
                  href="/products"
                  className="inline-flex h-[52px] w-full items-center justify-center gap-2 rounded-full bg-white px-7 text-[14px] font-[600] text-charcoal-900 transition-all hover:bg-cream-50 sm:w-auto md:h-[54px] lg:w-auto"
                >
                  Browse catalogue
                </Link>
                <a
