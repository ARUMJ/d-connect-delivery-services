...
const variantStyles: Record<ButtonVariant, string> = {
  primary:
    "bg-tangerine-500 text-white hover:bg-tangerine-600 active:bg-tangerine-600 shadow-[0_6px_20px_rgba(255,107,24,0.22)] hover:shadow-[0_10px_28px_rgba(255,107,24,0.3)]",
  secondary:
    "bg-emerald-900 text-cream-50 hover:bg-emerald-800 active:bg-emerald-950 shadow-[0_4px_16px_rgba(14,51,39,0.12)]",
  ghost:
    "bg-transparent text-charcoal-900 hover:bg-charcoal-900/[0.06] active:bg-charcoal-900/[0.08]",
  outline:
    "bg-white/70 backdrop-blur-sm border border-charcoal-900/10 text-charcoal-900 hover:bg-charcoal-900 hover:text-cream-50 hover:border-charcoal-900",
};

const sizeStyles: Record<ButtonSize, string> = {
  sm: "h-10 px-4 text-[13px] rounded-full", // 40px for better touch target
  md: "h-11 px-6 text-[13.5px] rounded-full",
  lg: "h-[50px] px-7 text-[14.5px] rounded-full md:h-[52px] md:px-8 md:text-[15px]",
};
...
export function Button({
  ...
  const classes = cn(
    "inline-flex items-center justify-center gap-2 font-[500] tracking-[-0.01em] transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)]",
...
export function WhatsAppButton({
  ...
  return (
    <a
      ...
      className={cn(
        "inline-flex items-center justify-center gap-2 font-[600] tracking-[-0.01em] transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] rounded-full whitespace-nowrap select-none",
        "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-tangerine-500 focus-visible:ring-offset-2",
        variantStyles[variant],
        sizeStyles[size],
        className
